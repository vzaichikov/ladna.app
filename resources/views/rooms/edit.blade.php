...
@section('content')
    ...
    <form method="POST" action="{{ route('dashboard.accounts.rooms.update', [$account, $room]) }}" class="mt-6 max-w-2xl space-y-5 rounded-xl border border-slate-200 bg-white p-6 shadow-crm">
        @csrf
        @method('PUT')
