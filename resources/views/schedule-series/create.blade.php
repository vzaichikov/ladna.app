...
@section('content')
    ...
    <form method="POST" action="{{ route('dashboard.accounts.schedule-series.store', $account) }}" class="mt-6 max-w-3xl space-y-5 rounded-xl border border-stone-200 bg-white p-6 shadow-crm" data-schedule-series-form>
        @csrf
