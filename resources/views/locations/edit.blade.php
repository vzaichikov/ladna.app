...
@section('content')
    ...
    <form method="POST" action="{{ route('dashboard.accounts.locations.update', [$account, $location]) }}" class="mt-6 max-w-2xl space-y-5 rounded-xl border border-slate-200 bg-white p-6 shadow-crm">
        @csrf
        @method('PUT')
