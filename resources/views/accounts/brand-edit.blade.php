        ...
        <div class="mt-6 grid max-w-6xl gap-6 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)]">
            <section class="rounded-xl border border-stone-200 bg-white p-6 shadow-crm" data-print-section>
                ...
                <div class="hidden" data-qr-print-poster>
                    ...
                    <footer class="flex flex-col items-center gap-2 border-t border-stone-200 pt-6 text-center">
                        <x-ui.app-logo mark-class="h-9 w-9" text-class="text-slate-950" />
                        <div class="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">{{ __('app.powered_by_ladna') }}</div>
                    </footer>
                </div>
            </section>
