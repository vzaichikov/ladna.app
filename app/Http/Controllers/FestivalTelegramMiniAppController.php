...
class FestivalTelegramMiniAppController extends Controller
{
    ...
    private function labels(): array
    {
        return [
            ...
            'open_page' => __('app.festival_telegram_open_page'),
            ...
            'nominations' => __('app.festival_nominations'),
            'nomination_presented_by' => __('app.festival_nomination_presented_by'),
            'nomination_prize' => __('app.festival_nomination_prize'),
