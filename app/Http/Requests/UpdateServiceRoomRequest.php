...
class UpdateServiceRoomRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'rtsp_url' => [Rule::requiredIf($this->boolean('rtsp_enabled')), 'nullable', 'string', 'max:2048', new RtspUrl],
            'rtsp_enabled' => ['nullable', 'boolean'],
        ];
    }
