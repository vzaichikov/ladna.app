...
class StoreTrainerTypeRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        return [
            'name' => [
                ...
                'string',
                'max:255',
                Rule::unique((new TrainerType)->getTable(), 'name')->where('account_id', $account instanceof Account ? $account->id : null),
            ],
