...
class UpdateAccountRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'enabled_schedule_kinds.*' => [Rule::in(ScheduleKindRegistry::allValues())],
            'schedule_kind_colors_present' => ['nullable', 'boolean'],
            'schedule_kind_colors' => ['required_if:schedule_kind_colors_present,1', 'array:'.implode(',', ScheduleKindRegistry::allValues())],
