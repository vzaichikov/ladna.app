...
#[Fillable(['account_id', 'festival_ticket_order_id', 'festival_admission_type_id', 'admission_name', 'admission_description', 'price_tier', 'unit_price_cents', 'quantity', 'total_cents'])]
class FestivalTicketOrderItem extends Model
{
    ...
    {
        return ['unit_price_cents' => 'integer', 'quantity' => 'integer', 'total_cents' => 'integer'];
    }
