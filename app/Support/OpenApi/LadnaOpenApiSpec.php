    ...
    private function schemas(): array
    {
        return [
            ...
            'McpCustomerBookingInvestigationArguments' => [
                ...
                'description' => 'Arguments for investigate-customer-booking-ledger. The date window affects only the detailed timeline; all-time history and trial eligibility use as_of.',
                'properties' => [
