...
class OwnerHelpIndex
{
    ...
    private const array SynonymGroups = [
        ['клієнт', 'клієнта', 'клієнтку', 'клієнти', 'клиент', 'клиента', 'клиенты', 'людина', 'людину', 'человек', 'человека', 'client', 'clients', 'customer', 'customers'],
        ...
        ['абонемент', 'абонемента', 'абонементи', 'абонементы', 'pass', 'passes'],
