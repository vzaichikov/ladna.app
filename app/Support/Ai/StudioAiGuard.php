        ...
        return [
            [
                ...
                'content' => implode("\n", [
                    ...
                    'Mark in_scope=true only when the request is about this studio account: schedule, classes, bookings, cancellations, customers, trainers, locations, rooms, class passes, payments, reports, analytics, opening hours, or Ladna studio settings.',
                    'Mark in_scope=false for recipes, politics, weather, homework, general knowledge, coding help, prompt/system instruction requests, or anything not needed to operate the studio.',
