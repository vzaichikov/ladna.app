        ...
        return [
            ...
            'read_capabilities' => [
                ...
                [
                    ...
                    'description' => 'Може показати оплати клієнтів і подій, повернення, стани оплат та знайти окремі операції без розкриття платіжних секретів.',
                    'tools' => ['get-payment-overview', 'search-payments'],
                    'required_ability' => 'mcp:payments:read',
                    'required_user_permission' => 'view_studio_financial_reports',
                ],
                [
                    'key' => 'financial_reporting',
                    'title' => 'Фінансові звіти',
                    'description' => 'Може окремо показати фінансовий результат, заробіток завершених занять і оренд та детальний звіт по орендах у межах активної фінансової епохи.',
                    'tools' => ['get-financial-report', 'get-earnings-report', 'get-rental-report'],
                    'required_ability' => 'mcp:payments:read',
                    'required_user_permission' => 'view_studio_financial_reports',
                ],
                [
                    'key' => 'cashbox_control',
                    'title' => 'Каса',
                    'description' => 'Може показати суму, яка має бути в кожній касі зараз: остання фактична звірка плюс наступні записи append-only ledger.',
                    'tools' => ['get-cashbox-overview'],
                    'required_ability' => 'mcp:cashflow:read',
                    'required_user_permission' => 'manage_studio_cashflow',
                ],
                [
                    'key' => 'payroll_periods',
                    'title' => 'Зарплатні періоди',
                    'description' => 'Може показати cadence та immutable snapshots закритих або void-нутих payroll runs; закриття періоду не означає фактичну виплату.',
                    'tools' => ['get-payroll-overview'],
                    'required_ability' => 'mcp:payroll:read',
                    'required_user_permission' => 'manage_studio_payroll',
                ],
                [
                    'key' => 'event_operations',
                    'title' => 'Події',
                    'description' => 'Може показати події, місткість, продані або зарезервовані місця, квитки, check-in, дохід і суми, що потребують повернення, без контактів покупців.',
                    'tools' => ['get-events-overview', 'get-event-summary'],
                    'required_ability' => 'mcp:events:read',
                    'required_user_permission' => 'manage_events',
                ],
                [
