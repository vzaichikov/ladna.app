...
class FeaturesPageTest extends TestCase
{
    ...
    public function test_ukrainian_features_page_renders_navigation_sections_and_screenshots(): void
    {
        ...
        $response
            ...
            ->assertSee('Події, квитки та контроль входу')
            ->assertSee('AI-асистент, який справді допомагає керувати студією')
            ->assertSee('Закриті командні тренування, методичні зустрічі та зйомки')
            ...
            ->assertSee('assistant-screenshot-uk.png', false)
            ->assertSee('href="#events"', false)
            ->assertSee('href="#assistant"', false)
            ->assertSee('Український діалог з AI-асистентом Ladna про продажі подій', false)
    ...
    public function test_english_features_page_controls_the_locale_and_language_switch(): void
    {
        ...
        $response
            ...
            ->assertSee('Events, tickets, and door check-in')
            ->assertSee('An AI assistant that genuinely helps you run your studio')
            ->assertSee('Team-only training, methodology meetings, and content shoots')
            ->assertSee('Connect more when you need it')
            ->assertSee('assistant-events-en.png', false)
            ->assertSee('assistant-customer-en.png', false)
            ->assertSee('assistant-screenshot-en.png', false)
            ->assertSee('English Ladna AI assistant conversation about event sales', false)
    ...
    public function test_landing_keeps_hero_copy_and_links_the_existing_cta_to_features(): void
    {
        $this->get(route('home'))
            ...
            ->assertSee('AI-асистент, який справді допомагає керувати студією')
            ->assertSee('href="'.route('features').'#assistant"', false)
        ...
        $this->get(route('home.en'))
            ...
            ->assertSee('href="'.route('features.en').'"', false)
            ->assertSee('An AI assistant that genuinely helps you run your studio')
            ->assertSee('href="'.route('features.en').'#assistant"', false)
