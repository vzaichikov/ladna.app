...
class ApiDocumentationTest extends TestCase
{
    public function test_api_documentation_page_renders_endpoints_and_code_examples(): void
    {
        $this->get(route('api-docs.show'))
            ...
            ->assertSee('A timely customer cancellation releases the class-pass session')
    ...
    public function test_openapi_json_documents_public_and_lead_endpoints(): void
    {
        ...
        $response
            ...
            ->assertJsonPath('paths./api/v1/mobile/bookings/{classBooking}.delete.summary', 'Cancels a booking. A timely customer cancellation releases the class-pass session; staff need manage_bookings and their cancellation keeps the session consumed.')
