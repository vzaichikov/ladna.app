...
class HelpPagesTest extends TestCase
{
    ...
    public function test_festivals_help_explains_the_independent_competition_flow(): void
    {
        $this->get(route('help.show', 'festivals', false))
            ...
            ->assertSee('Напрямки, Класифікації, Категорії, Сценарії реєстрації, Вимоги, Внески та Контент і медіа відкриваються окремими сторінками', false)
            ->assertSee('напрямки та класифікації формують категорію; категорія обирає сценарій; кроки сценарію містять вимоги й внески', false)
