...
class HelpPagesTest extends TestCase
{
    ...
    public function test_festivals_help_explains_the_independent_competition_flow(): void
    {
        $this->get(route('help.show', 'festivals', false))
            ...
            ->assertSee('Напрямки, Категорії, Сценарії реєстрації, Поля реєстрації, Внески та Контент і медіа відкриваються окремими сторінками', false)
            ->assertSee('Категорію додають і редагують на окремій сторінці', false)
