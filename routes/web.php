...
Route::middleware(['auth:web', EnsureOwnerOnboardingComplete::class, PreventReadOnlyDemoMutations::class, PreventExpiredSubscriptionMutations::class, RecordAccountActivity::class])
    ...
    ->group(function (): void {
        ...
        Route::prefix('accounts/{account}/festivals')->name('accounts.festivals.')->middleware([EnsureFestivalsEnabled::class, EnsureFestivalEditionWritable::class])->scopeBindings()->group(function (): void {
            ...
            Route::patch('{festivalEdition:id}/judging/score-sheets/{festivalScoreSheet}/unlock', [FestivalJudgingController::class, 'unlockStaff'])->whereNumber('festivalEdition')->name('judging.score-sheets.unlock');
            ...
            Route::get('{festivalEdition:id}/judging/results/{festivalCategory}/preview', [FestivalResultController::class, 'preview'])->whereNumber('festivalEdition')->name('judging.results.preview');
            Route::post('{festivalEdition:id}/judging/results/{festivalCategory}/publish', [FestivalResultController::class, 'publish'])->whereNumber('festivalEdition')->name('judging.results.publish');
