...
use App\Http\Controllers\FestivalPromoCodeQuoteController;
...
Route::middleware([EnsurePublicSubscriptionIsActive::class, EnsureFestivalsEnabled::class, EnsureFestivalEditionWritable::class])->group(function (): void {
    ...
    Route::post('/{accountSlug}/festivals/{editionSlug}/entrance/promo-code', [FestivalPromoCodeQuoteController::class, 'entrance'])->middleware('throttle:festival-checkout')->name('public.festivals.entrance.promo-code');
    ...
    Route::post('/{accountSlug}/festivals/{editionSlug}/admission/promo-code', [FestivalPromoCodeQuoteController::class, 'admission'])->middleware('throttle:festival-checkout')->name('public.festivals.admission.promo-code');
